...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LCTL, KC_LGUI, MO(1),                  KC_SPC,                     KC_RALT, MO(2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT,   KC_P0, KC_PDOT, KC_PENT),
	...
	KC_DEL,      _______, _______, _______, _______, _______, _______,  KC_LEFT, KC_DOWN,  KC_UP, KC_RGHT, _______, _______,       _______, _______, _______, _______, _______, 
